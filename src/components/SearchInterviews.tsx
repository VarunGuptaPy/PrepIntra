  ...
  const interviewWidgets: InterviewWidget[] = [
    {
      ...
      description:
        "Practice technical interviews for software development roles.",
    },
    {
      title: "Data Science",
      description: "Prepare for data analysis and machine learning interviews.",
    },
    {
      title: "Product Management",
      description: "Hone your product strategy and leadership skills.",
    },
    {
      title: "Marketing",
      description:
        "Get ready for brand strategy and digital marketing interviews.",
    },
    {
      title: "Sales",
      description: "Sharpen your pitch and negotiation skills for sales roles.",
    },
    {
      title: "Finance",
      description:
        "Practice financial modeling and investment banking interviews.",
    },
  ];

  const filteredWidgets = interviewWidgets.filter(
    (widget) =>
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      {filteredWidgets.length === 0 && (
        <p className="text-center text-gray-400 mt-8">
          No interviews found matching your search. Try a different term.
        </p>
      )}
    </div>
  );
